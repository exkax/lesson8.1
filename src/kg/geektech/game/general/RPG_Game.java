...
public class RPG_Game {
    ...
    public static void start() {
        ...
        Thor thor = new Thor(300, 40);
        TrickyBastard bastard = new TrickyBastard(250, 10);
        Antman antman = new Antman(220,20);
        Hero[] heroes = {warrior, doc, magic, berserk, assistant, thor, bastard, antman};
